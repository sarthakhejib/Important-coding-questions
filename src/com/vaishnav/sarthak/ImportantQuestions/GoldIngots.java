...
public class GoldIngots {
	
	public static int largestIngots(int heightOfIndividualIngot,int breathOfIndividualIngot,int ingots[], int numberOfGoldIngots  ) {
		...
		return (int)((totalVolumeOfIngots-maxValue)%mod);		
	}
